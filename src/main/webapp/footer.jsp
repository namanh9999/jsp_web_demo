...
<footer class="text-center text-lg-start bg-white text-muted" >
	...
	<h1 align="center">Sometime by losing a battle you find a new way
		to win the war (Donald Trump)</h1>
	<section
			...
			<div class="row mt-3">
				...
				<div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
					...
					<h6 class="text-uppercase fw-bold mb-4">
						<i class="fas fa-gem me-3 text-secondary"></i>Bug Corporation
					</h6>
					<p>Make the world become better
				</div>
				<!-- Grid column -->
	...
	<div class="text-center p-4"
		...
		© 2023 Copyright: <a class="text-reset fw-bold" href="#">BugCorpation.com</a>
	</div>
	<!-- Copyright -->
</footer>
<!-- Footer -->