...
<body class="py-4">
	...
	<main>
		<div class="container">
			...
			<h1>Bug Corporation</h1>
			<h2 class="mt-4">Product Information</h2>
			<p>This is all product on your site</p>
			...
			<div class="row mb-3 text-center">
				...
				<div class="col-md-3 themed-grid-col">Path</div>

				<%
				for (Product pr : list) {
				%>
				<div class="row mb-3 text-center">
					<div class="ratio ratio-16x9 col-md-3 themed-grid-col">
						<iframe src="<%=url%>/Product/Path/<%=pr.getPath()%>"
							allow="encrypted-media" title="YouTube video"></iframe>
					</div>
					<div class="col-md-3 themed-grid-col"><%=pr.getProductName()%></div>
					<div class="col-md-3 themed-grid-col"><%=pr.getAuthor()%></div>
					<div class="col-md-3 themed-grid-col"><%=pr.getDescription()%></div>
				</div>
				...
				<p>
					Get two columns <strong>starting at desktops and scaling
						to large desktops</strong>.
				</p>
				<div class="row mb-3 text-center">
				...
				<p>The Bootstrap v5 grid system has six tiers of classes: xs
					...
					flexible layouts.</p>
				<p>Each tier of classes scales up, meaning if you plan on
					setting the same widths for md, lg, xl and xxl, you only need to
					specify md.</p>
				<div class="row mb-3 text-center">
					<div class="col-md-8 themed-grid-col">.col-md-8</div>
