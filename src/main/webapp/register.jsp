										...
										<div class="form-group radio-check">
											<div>
												<input type="radio" name="Gender"
													value="Men"<%=(gender.equals("Men")) ? "checked='checked'" : ""%>
													id="male"> <label for="male">Men</label>
											</div>
											<div>
												<input type="radio" name="Gender"
													value="Women"<%=(gender.equals("Women")) ? "checked='checked'" : ""%>
								...
								<div class="form-group">
									<div class="form-check form-switch">
										<input class="form-check-input" type="checkbox" role="switch"
											id="emailRegister" name="emailRegister"<%=(emailRegister.equals("on")) ? "checked='checked'" : ""%>> <label
